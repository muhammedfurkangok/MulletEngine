...
assimp can be used in two ways: linking against the pre-built third_party or building the library on your own. The former
option is the easiest, but the assimp distribution contains pre-built third_party only for Visual C++ 2013, 2015 and 2017.
...
@section install_prebuilt Using the pre-built third_party with Visual C++ 8/9

If you develop at Visual Studio 2015 or 2017, you can simply use the pre-built linker third_party provided in the distribution.
