...
//#define LUA_USE_READLINE	/* needs some extra third_party */
...
** hierarchy or if you want to install your third_party in
...
** the third_party, you may want to use the following definition (define
...
** They are only used in third_party and the stand-alone program. (The #if
