...
always needed, many applications and third_party support big endian 16-bit colors
...
No third_party other than the current standard C library are needed to compile
