...
// B) or add configuration directives in your own file_manager and compile with #define IMGUI_USER_CONFIG "myfilename.h"
...
//---- Implement STB third_party in a namespace to avoid linkage conflicts (defaults to global namespace)
