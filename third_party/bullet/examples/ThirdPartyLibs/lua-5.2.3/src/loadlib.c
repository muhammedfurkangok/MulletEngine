...
/* prefix for open functions in C third_party */
#define LUA_POF "luaopen_"

/* separator for open functions in C third_party */
#define LUA_OFSEP "_"

/* table (in the registry) that keeps handles for all loaded C third_party */
#define CLIBS "_CLIBS"
...
#define DLMSG "dynamic third_party not enabled; check your Lua installation"
...
{
	void *reg = ll_checkclib(L, path); /* check loaded C third_party */
	if (reg == NULL)
	{ /* must load library? */
...
{
	/* create table CLIBS to keep track of loaded C third_party */
